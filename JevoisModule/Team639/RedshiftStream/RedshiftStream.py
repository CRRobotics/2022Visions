...
# 
# @videomapping YUYV 320 240 15 YUYV 320 240 15 Team639 RedshiftStream
...
class RedshiftStream:
    ...
    def process(self, inframe, outframe):
        ...
        # Write a title:
        cv2.putText(outimg, "JeVois RedshiftStream", (3, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255,255,255))
